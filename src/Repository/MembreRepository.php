...
class MembreRepository extends ServiceEntityRepository
{
    ...
    public function findOneByUsername($value): ?Membre
    {
        return $this->createQueryBuilder('m')
    ...
    public function findOneByPass($value): ?Membre
    {
        return $this->createQueryBuilder('m')
            ->andWhere('m.motDePasse = :val')
            ->setParameter('val', $value)
            ->getQuery()
            ->getOneOrNullResult()
        ;
    ...
    public function findOneByEmail($value): ?Membre
    {
        return $this->createQueryBuilder('m')
